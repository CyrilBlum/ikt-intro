...
const eduzh: Step[] = [
  ...
  { image:"/screenshots/IMG_0689.PNG", altImage:"/screenshots/android-18-fertig.jpg", phase:"Fertig", title:"Ihr Konto ist bereit", text:"Authenticator, Telefonnummer und persönliches Kennwort sind eingerichtet. Melden Sie sich nun einmal auf Moodle an.", tip:"Moodle werden Sie künftig in vielen Kursen verwenden. In der IKT-Einführung markieren Sie dort fortlaufend, welche Bereiche Sie bereits erledigt haben. So können Ihre Lehrpersonen den Fortschritt aller Schülerinnen und Schüler sehen. Die Links in Moodle führen jeweils zurück zu den passenden Anleitungen auf dieser Seite." },
];
