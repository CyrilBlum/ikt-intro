...
const officeMobileIphone: Step[] = [
  ...
  {phase:"iPhone · Prüfen",title:"Die drei Apps sind bereit",text:"Kontrollieren Sie: Teams zeigt Ihre Schulteams, Outlook Ihr EduZH-Postfach und OneNote lässt sich mit Ihrem Schulkonto öffnen.",shortcut:"✓",tip:"Prüfen Sie Ihre Schul-E-Mails in Outlook und Ihre Teams-Nachrichten jeden Tag. Wichtige Informationen und Aufträge werden dort kommuniziert."},
];
